...
(function (root, factory) {
     ...
     */
    function DistanceTool(map, opts) {
        if (!map) {
            return;
        }
    ...
    DistanceTool.prototype.open = function () {
         ...
         */
        var distClick = function distClick(e) {
            var map = me._map;
            if (!me._isOpen) {
                return;
            }
         ...
         * @param {Object} e event对象
         */
        var distMove = function distMove(e) {
            if (!me._isOpen) {
                return;
            }
         ...
         * @param {Object} e event对象
         */
        var distDblclick = function distDblclick(e) {
            if (!me._isOpen) {
                return;
            }
            // 结束时，删除绑定的事件
         ...
         * @param {Object} e event对象
         */
        var distKeyDown = function distKeyDown(e) {
            e = window.event || e;
            if (e.keyCode == 27) {
                // [ESC]退出本次测距
                me._clearCurData();
         ...
         * @param {Object} e event对象
         */
        var distMouseUp = function distMouseUp(e) {
            e = window.event || e;
            var ieVersion = 0;
        ...
        this.bindFunc = [{ elem: OperationMask.getDom(this._map), type: "click", func: distClick }, { elem: OperationMask.getDom(this._map), type: "dblclick", func: distDblclick }, { elem: document, type: "mousemove", func: distMove }, { elem: document, type: "keydown", func: distKeyDown }, { elem: OperationMask.getDom(this._map), type: "mouseup", func: distMouseUp }];
        return true;
    };
    ...
    DistanceTool.prototype._dispatchLastEvent = function () {
        ...
        event.points = this._points ? this._points.slice(0) : [];
        event.overlays = this._paths ? this._paths.slice(0, this._paths.length - 1) : [];
    ...
    DistanceTool.prototype._addSecPoint = function (pt) {
        var ico = this._opts.secIcon ? this._opts.secIcon : new BMap.Icon("http://api.map.baidu.com/images/mapctrls.png", new BMap.Size(11, 11), { imageOffset: new BMap.Size(-26, -313) });
    ...
    DistanceTool.prototype._setCursor = function (cursor) {
        ...
        var csr = /webkit/.test(navigator.userAgent.toLowerCase()) ? "url(" + this._opts.cursor + ") 3 6, crosshair" : "url(" + this._opts.cursor + "), crosshair";
    ...
    DistanceTool.prototype._processLastOp = function () {
        ...
        // 添加关闭按钮
        var bico = this._opts.closeIcon ? this._opts.closeIcon : new BMap.Icon("http://api.map.baidu.com/images/mapctrls.gif", new BMap.Size(12, 12), { imageOffset: new BMap.Size(0, -14) });
        disObj.closeBtn = new BMap.Marker(disObj.points[disObj.points.length - 1], { icon: bico,
    ...
    var OperationMask = {
         ...
         * @return 无返回值
         */
        _createMask: function _createMask(map) {
            this._map = map;
            if (!this._map) {
                return;
            }
         ...
         * @return Point对象的位置信息
         */
        getDrawPoint: function getDrawPoint(e, n) {
            e = window.event || e;
