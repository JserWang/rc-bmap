...
var Map = (_temp = _class = function (_React$Component) {
  ...
  renderCallBack: _propTypes2.default.func,
  ...
  this.init = function (BMap) {
    var _props = _this2.props,
        ...
        renderCallBack = _props.renderCallBack,
        contextMenu = _props.contextMenu,
        resetProps = _objectWithoutProperties(_props, ['highResolution', 'autoResize', 'mapClick', 'renderCallBack', 'contextMenu']);
