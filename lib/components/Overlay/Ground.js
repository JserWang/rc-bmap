  ...
  _createClass(Ground, [{
    ...
    value: function init() {
      var _props = this.props,
          ...
          displayOnMinLevel = _props.displayOnMinLevel,
          displayOnMaxLevel = _props.displayOnMaxLevel,
      ...
      this.instance = new global.BMap.GroundOverlay((0, _util.getBound)(bounds), opts);
