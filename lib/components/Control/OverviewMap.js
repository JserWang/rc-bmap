...
var OverviewMap = (0, _ReactComponent2.default)(_class = function (_BaseControl) {
  _inherits(OverviewMap, _BaseControl);
  ...
  _createClass(OverviewMap, [{
    ...
    value: function init() {
      ...
      var opts = {
        ...
        size: (0, _util.getSize)(size.width, size.height),
        isOpen: isOpen
      };

      this.instance = new global.BMap.OverviewMapControl(opts);
      (0, _util.bindEvents)(this.instance, 'OVERVIEW_MAP', events);
    }
  }]);
