...
var CityList = (0, _ReactComponent2.default)(_class = function (_BaseControl) {
  _inherits(CityList, _BaseControl);

  function CityList() {
    _classCallCheck(this, CityList);

    return _possibleConstructorReturn(this, (CityList.__proto__ || Object.getPrototypeOf(CityList)).apply(this, arguments));
  }
    ...
    value: function init() {
      var _props = this.props,
        ...
        height: 0
          ...
          onChangeBefore = _props.onChangeBefore,
          onChangeAfter = _props.onChangeAfter;
