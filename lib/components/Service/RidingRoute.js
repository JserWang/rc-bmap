...
var RidingRoute = (0, _ReactComponent2.default)(_class = function (_BaseService) {
  _inherits(RidingRoute, _BaseService);

  function RidingRoute() {
    _classCallCheck(this, RidingRoute);

    return _possibleConstructorReturn(this, (RidingRoute.__proto__ || Object.getPrototypeOf(RidingRoute)).apply(this, arguments));
  }

  _createClass(RidingRoute, [{
    key: 'init',
    value: function init() {
