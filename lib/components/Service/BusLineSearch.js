...
var BusLineSearch = (0, _ReactComponent2.default)(_class = function (_BaseService) {
  _inherits(BusLineSearch, _BaseService);

  function BusLineSearch() {
    _classCallCheck(this, BusLineSearch);

    return _possibleConstructorReturn(this, (BusLineSearch.__proto__ || Object.getPrototypeOf(BusLineSearch)).apply(this, arguments));
  }

  _createClass(BusLineSearch, [{
    key: 'init',
    value: function init() {
      var _props = this.props,
          _props$location = _props.location,
          location = _props$location === undefined ? this.map : _props$location,
          onGetBusListComplete = _props.onGetBusListComplete,
          onGetBusLineComplete = _props.onGetBusLineComplete,
          onBusListHtmlSet = _props.onBusListHtmlSet,
          onBusLineHtmlSet = _props.onBusLineHtmlSet,
      ...
      this.instance = new global.BMap.BusLineSearch(_location, {
        ...
        onBusListHtmlSet: onBusListHtmlSet,
        onBusLineHtmlSet: onBusLineHtmlSet,
