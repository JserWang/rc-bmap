...
var TransitRoute = (0, _ReactComponent2.default)(_class = function (_BaseService) {
  _inherits(TransitRoute, _BaseService);

  function TransitRoute() {
    _classCallCheck(this, TransitRoute);

    return _possibleConstructorReturn(this, (TransitRoute.__proto__ || Object.getPrototypeOf(TransitRoute)).apply(this, arguments));
  }

  _createClass(TransitRoute, [{
    key: 'init',
    value: function init() {
      var _props = this.props,
          ...
          intercityPolicy = _props.intercityPolicy,
          transitTypePolicy = _props.transitTypePolicy,
