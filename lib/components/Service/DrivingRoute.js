...
var DrivingRoute = (0, _ReactComponent2.default)(_class = function (_BaseService) {
  _inherits(DrivingRoute, _BaseService);

  function DrivingRoute() {
    _classCallCheck(this, DrivingRoute);

    return _possibleConstructorReturn(this, (DrivingRoute.__proto__ || Object.getPrototypeOf(DrivingRoute)).apply(this, arguments));
  }
