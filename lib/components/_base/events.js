...
var AUTO_COMPLETE = exports.AUTO_COMPLETE = ['onconfirm', 'onhighlight'];

var DRAWING_MANAGER = exports.DRAWING_MANAGER = ['circlecomplete', 'markercomplete', 'overlaycomplete', 'polygoncomplete', 'polylinecomplete', 'rectanglecomplete'];

var DISTANCE_TOOL = exports.DISTANCE_TOOL = ['onaddpoint', 'ondrawend'];